...
def predict_coqa_customized(strategy, input_meta_data, bert_config,
  ...
  with tf.device(primary_cpu_task):
    predict_dataset = input_pipeline.create_coqa_bert_span_dataset(
...
def train_coqa(strategy,
  ...
  train_input_fn = functools.partial(
      input_pipeline.create_coqa_bert_span_dataset,
  ...
  def _get_coqa_model():
    ...
    coqa_model, core_model  = coqa_models.coqa_model_bert_span(
        bert_config,
        max_seq_length,
        max_answer_length,
...
def predict_coqa(strategy, input_meta_data):
  ...
  eval_examples = coqa_bert_span_lib.read_coqa_examples(
  ...
  eval_writer = coqa_bert_span_lib.FeatureWriter(
  ...
  # later on.
  dataset_size = coqa_bert_span_lib.convert_examples_to_features(
