...
def train_coqa(strategy,
  ...
  train_input_fn = functools.partial(
      input_pipeline.create_coqa_dataset,
  ...
  def _get_coqa_model():
    ...
    coqa_model, core_model = bert_models.coqa_model(
        bert_config,
        max_seq_length,
...
def predict_coqa(strategy, input_meta_data):
  ...
  eval_examples = coqa_lib.read_coqa_examples(
  ...
  eval_writer = coqa_lib.FeatureWriter(
  ...
  # later on.
  dataset_size = coqa_lib.convert_examples_to_features(
